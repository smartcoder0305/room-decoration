...
function Page2() {
  ...
  const handelSubmitData = async () => {
    ...
    try {
      const submitPage = await axios.post(`${BASE_URL}/admin/addPages`, { pname: 'page2', data: value }, config)
  ...
  const getData = async () => {
    ...
    try {
      ...
      const getPage = await axios.post(`${BASE_URL}/admin/getPages`, { pname: 'page2'}, config)
