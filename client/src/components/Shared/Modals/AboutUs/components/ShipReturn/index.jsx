  ...
  <div className='aboutus_shipreturn'>
    <div className='aboutus_shipreturn_table'>
      <div className='aboutus_shipreturn_table_row' style={{display: "flex", justifyContent:"space-between", alignItems: "center"}}>
        ...
        <span className='aboutus_shipreturn_table_row_item shipreturn_bold'>עלות משלוח<br />מתחת ל130 שח</span>
        <span className='aboutus_shipreturn_table_row_item shipreturn_bold'>עלות משלוח<br />מ130 שח ומעלה</span>
