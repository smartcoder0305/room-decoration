...
const { addPages, getPages, getAllPages, getPageById, updatePageById, deletePageById } = require("../controller/page/pageController");
const {
  getCupon,
  addCupon,
  countLiveVisitor,
...
router.put("/image_keep/:uid", image_keep);//useless
